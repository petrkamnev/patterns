...
private:
    std::string name;
    std::string current_kind_of_bread;
...
public:
    ...
    void choose_kind_of_bread(std::string &kind)
    {
...
private:
    std::string kind_of_bread;
    int cooking_time;
    int cooking_temperature;
...
public:
    ...
    void remember_the_temperature(int &temperature)
    { // храним температуру,
    ...
    void put_the_bread(int &minutes)
    {
        ...
        std::cout << "BREAD: is in the oven.\n";
    }
    void get_the_bread()
    {
        std::cout << "BREAD: is out of the oven.\n";
    }
    std::pair<int, int> get_cooking_time_and_temperature()
    {
...
public:
    ...
    void turn_on_the_oven(int &temperature_)
    {
...
public:
    ...
    Bread cook_bread(std::string &kind, int &time, int &temperature)
    {
        Bread bread;
    ...
    void taste_the_bread(Bread &bread)
    { // пекарня проверяет, правильно ли приготовлен хлеб
